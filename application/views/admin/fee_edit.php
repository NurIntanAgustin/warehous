        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <hr class="mb-2">
                    <div class="mt-4">
                        <form action="<?= base_url('admin/editfee'); ?>" method="POST">
                        <input type="hidden" name="fee_id" value="<?= $fee['fee_id'] ?>"> <div class="mb-3">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Keterangan</label>
                                <input type="text" name="keterangan" class="form-control" id="exampleFormControlInput1" placeholder="Keterangan" value="<?= $fee['keterangan'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Tarif Warehouse</label>
                                <input type="text" name="fee" class="form-control" id="exampleFormControlInput1" placeholder="Tarif Warehouse" value="<?= $fee['fee'] ?>">
                            </div>
                            <div class="mb-3">
