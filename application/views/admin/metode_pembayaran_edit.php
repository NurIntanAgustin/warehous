        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <hr class="mb-2">
                    <div class="mt-4">
                        <form action="<?= base_url('admin/editmetode'); ?>" method="POST">
                        <input type="hidden" name="metode_id" value="<?= $metode['metode_id'] ?>"> <div class="mb-3">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Metode Pembayaran</label>
                                <input type="text" name="metode_pembayaran" class="form-control" id="exampleFormControlInput1" placeholder="Metode Pembayaran" value="<?= $metode['metode_pembayaran'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Nomor</label>
                                <input type="text" name="no_rek" class="form-control" id="exampleFormControlInput1" placeholder="Nomor" value="<?= $metode['no_rek'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Pemilik</label>
                                <input type="text" name="pemilik" class="form-control" id="exampleFormControlInput1" placeholder="Pemilik" value="<?= $metode['pemilik'] ?>">
                            </div>
                            <div class="mb-3">
