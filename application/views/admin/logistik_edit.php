                    ...
                    <div class="mt-4">
                        <form action="<?= base_url('admin/editlogistik'); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="box" class="form-control" id="exampleFormControlInput1" placeholder="Box" value="<?= $logistik['box'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Resi Pengiriman</label>
                                <input type="text" name="resi_pengiriman" class="form-control" id="exampleFormControlInput1" placeholder="Resi Pengiriman" value="<?= $logistik['resi_pengiriman'] ?>">
                            </div>
                            <div class="mb-3">
