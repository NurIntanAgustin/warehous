        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-3">
                        <div class="col-3">
                            <a href="<?= base_url('admin/link_create') ?>" class="btn btn-primary btn-sm">Tambah Data</a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('admin/link_edit/' . $link['link_id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                                        <a href="<?= base_url('admin/link_hapus/' . $link['link_id']) ?>" class="btn btn-danger btn-sm">Hapus</a>
                                    </td>
                                </tr>
                            <?php
                            }
