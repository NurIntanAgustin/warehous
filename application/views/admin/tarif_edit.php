            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="hidden" name="tarif_id" value="<?= $tarif['tarif_id'] ?>"> <div class="mb-3">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Keterangan</label>
                                <input type="text" name="keterangan" class="form-control" id="exampleFormControlInput1" placeholder="Keterangan" value="<?= $tarif['keterangan'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Tarif</label>
                                <input type="text" name="tarif" class="form-control" id="exampleFormControlInput1" placeholder="Tarif" value="<?= $tarif['tarif'] ?>">
                            </div>
                            <div class="mb-3">
