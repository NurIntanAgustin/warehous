        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <hr class="mb-2">
                    <div class="mt-4">
                        <form action="<?= base_url('admin/simpanlogistik'); ?>" method="POST">
                            <div class="mb-3">
                            <label for="pengiriman_id">Resi Barang</label>
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Box</label>
                                <input type="number" name="box" class="form-control" id="exampleFormControlInput1" placeholder="Box">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Resi Pengiriman</label>
                                <input type="text" name="resi_pengiriman" class="form-control" id="exampleFormControlInput1" placeholder="Resi Pengiriman">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="gambar_arrived_kr" name="gambar_arrived_kr" class="form-control" id="exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Warehouse Indonesia</label>
                                <input type="file" id="gambar_arrived_ina" name="gambar_arrived_ina" class="form-control" id="exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
