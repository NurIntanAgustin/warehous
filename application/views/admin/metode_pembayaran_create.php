        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <hr class="mb-2">
                    <div class="mt-4">
                        <form action="<?= base_url('admin/simpanmetode'); ?>" method="POST">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Metode Pembayaran</label>
                                <input type="text" name="metode_pembayaran" class="form-control" id="exampleFormControlInput1" placeholder="Metode Pembayaran">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Nomor</label>
                                <input type="text" name="no_rek" class="form-control" id="exampleFormControlInput1" placeholder="Nomor">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Pemilik</label>
                                <input type="text" name="pemilik" class="form-control" id="exampleFormControlInput1" placeholder="Pemilik">
                            </div>
                            <div class="mb-3">
