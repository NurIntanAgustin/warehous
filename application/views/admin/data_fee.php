        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-3">
                        <div class="col-3">
                            <a href="<?= base_url('admin/fee_create') ?>" class="btn btn-primary btn-sm">Tambah Data</a>
                        </div>
                    </div>
                    ...
                    <table class="table mt-3">
                        ...
                        <tbody>
                            <?php
                            foreach ($allfee as $no => $fee) {
                            ?>
                                <tr>
                                    <th scope="row"><?= $no + 1 ?></th>
                                    <td><?= $fee['keterangan']; ?></td>
                                    <td>Rp<?= number_format($fee['fee'],0,',','.'); ?></td>
                                    <td>
                                        <a href="<?= base_url('admin/fee_edit/' . $fee['fee_id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                                        <a href="<?= base_url('admin/fee_hapus/' . $fee['fee_id']) ?>" class="btn btn-danger btn-sm">Hapus</a>
                                    </td>
                                </tr>
                            <?php
                            }
