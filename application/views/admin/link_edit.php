            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="hidden" name="link_id" value="<?= $link['link_id'] ?>"> <div class="mb-3">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Keterangan</label>
                                <input type="text" name="keterangan" class="form-control" id="exampleFormControlInput1" placeholder="Keterangan" value="<?= $link['keterangan'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Link Checkout</label>
                                <input type="text" name="link" class="form-control" id="exampleFormControlInput1" placeholder="Link Checkout" value="<?= $link['link'] ?>">
                            </div>
                            <div class="mb-3">
